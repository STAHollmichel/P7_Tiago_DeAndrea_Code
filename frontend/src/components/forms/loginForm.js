        ...
        <div className='form-signin'>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='form-floating'>
                    ...
                    <input {...register("email")} type="email" className="form-control bg-light" id="floatingInput" placeholder="nom@example.fr"/>
                </div>
                <div className='form-floating'>
                    <label for="floatingPassword" className="form-label">Mot de passe</label>
                    <input {...register("password")} type="password" className="form-control bg-light" id="floatingPassword" placeholder="Mot de passe"/>
                </div>
